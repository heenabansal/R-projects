...
# Import the data
setwd("/home/fractaluser/Backup/Courses/R301/H2O package exploration practice problem/")
loan_csv = "/home/fractaluser/Backup/Courses/R301/H2O package exploration practice problem/loan.csv"
